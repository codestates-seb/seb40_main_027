...
//    @Value("${jwt.secret-key}")
    private String secretKey = "abcdefghijknlmnopqrstuvwxyzabcdefghijknlmnopqrstuvwxyzabcdefghijknlmnopqrstuvwxyzabcdefghijknlmnopqrstuvwxyzzz";  // JWT 생성 및 검증시 사용되는 Secret Key
